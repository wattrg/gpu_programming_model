...
IMPORTED_LOCATION "/usr/local/cuda-12/lib64/libcudart.so"
INTERFACE_INCLUDE_DIRECTORIES "/usr/local/cuda-12/include"
)
ENDIF()
IF(NOT TARGET CUDA::cuda_driver)
ADD_LIBRARY(CUDA::cuda_driver UNKNOWN IMPORTED)
SET_TARGET_PROPERTIES(CUDA::cuda_driver PROPERTIES
IMPORTED_LOCATION "/usr/lib/x86_64-linux-gnu/libcuda.so"
INTERFACE_INCLUDE_DIRECTORIES "/usr/local/cuda-12/include"
)
ENDIF()
